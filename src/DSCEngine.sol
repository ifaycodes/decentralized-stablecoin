...
contract DSCEngine is ReentrancyGuard {
    ...
    error DSCEngine__BreakingHealthFactor(uint256 healthFactorValue);
    ...
    //to deposit to collateral and mint dsc in one go instead of calling depositCollateral and mintDsc seperately.
    ...
    //after collateral redeemed, health factor should still be > 1
    ...
    //amountDscToMint - the amount of dsc to mint
    // collateral value has to be more than minimum threshold
    ...
    /* Returns how close user is to liquidation: if it goes below 1, liquidation */
    ...
    function _revertIfHealthFactorIsBroken(address user) internal view {
        ...
        if (userHealthFactor < MIN_HEALTH_FACTOR) {
            revert DSCEngine__BreakingHealthFactor(userHealthFactor);
        }
    }
    ...
    function getAccountCollateralValue(address user) public view returns (uint256 tokenCollateralValueInUsd) {
        // loop through collateral tokens and get amounts deposited. then map it to the usd price
